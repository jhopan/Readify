    ...
    if (empty($errors)) {
        ...
        try {
            ...
            if ($role == 'member') {
                ...
                $db->query("INSERT INTO members (member_id, user_id, name, email, phone, join_date, status) VALUES (?, ?, ?, ?, ?, CURDATE(), 'active')", 
                    [$memberId, $userId, $name, $email, $phone]);
            }
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <select name="role" class="form-control" required>
                    ...
                    <option value="member" <?php echo (isset($_POST['role']) && $_POST['role'] == 'member') ? 'selected' : ''; ?>>Member (Anggota Perpustakaan)</option>
                    <option value="staff" <?php echo (isset($_POST['role']) && $_POST['role'] == 'staff') ? 'selected' : ''; ?>>Staff (Kelola Perpustakaan)</option>
